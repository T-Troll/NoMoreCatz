...
//const PORT = chrome.runtime.connectNative("com.ttroll.nomorecatz");
...
class BackgroundProcessing {
  ...
  constructor() {
    this.imageRequests = {};
    this.addListeners();
    //this.port = chrome.runtime.connectNative("com.ttroll.nomorecatz");
    //this.port.onMessage.addListener(onNativeMessage);
  ...
  async predict(imgElement) {
   ...
   canvas.height = imgElement.height;
    ...
    //this.port.postMessage({ width: imgElement.width, height: imgElement.height, data : imgData });
    chrome.runtime.sendNativeMessage('com.ttroll.nomorecatz',
    { width: imgElement.width, height: imgElement.height, data : imgData }, onNativeMessage);
